...
>
    <button
        type="button"
        class="group/disclosure-button mb-[2px] flex h-10 w-full items-center rounded-lg text-zinc-500 hover:bg-brand-yellow-700/5 hover:text-zinc-800 lg:h-8 dark:text-white/80 dark:hover:bg-brand-yellow-200 dark:hover:text-white"
    >
        <div class="ps-3 pe-4">
