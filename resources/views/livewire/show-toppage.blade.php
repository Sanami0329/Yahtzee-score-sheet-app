<div class="text-zinc-900">
    ...
    <section class="relative h-screen flex items-center justify-center text-white mt-6 overflow-hidden">
        ...
        <img src="{{ asset('images/top_image_dices2.jpg') }}" alt="dices" class="absolute w-full" style="opacity: 0.8;">

        <div class="relative w-full z-10 text-center py-8 mx-auto">
            <h1 class="mx-auto w-lg text-4xl md:text-6xl font-bold mb-6 bg-white/70 text-zinc-900 text-shadow">
                YahtzeeNote
            </h1>
            <div class="m-auto max-w-xl bg-white/70">
                <p class="text-lg md:text-xl mb-8 text-shadow text-zinc-900 ">
            ...
            <div class="max-w-4xl mx-auto space-y-12">
                ...
                <div class="flex flex-col md:flex-row gap-6 items-start">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-zinc-600 leading-relaxed">{{ $step['desc'] }}</p>
                    </div>
                </div>
...
<section id="practice-areas" class="py-16 bg-primary-light">
    <div class="container mx-auto px-4 lg:px-16">
        <div class="text-center mb-12">
            <p class="text-sm text-zinc-600 uppercase tracking-wider mb-2">Practice Areas</p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white border border-zinc-200 p-6 rounded-lg hover:border-primary transition group">
                <div class="flex items-start space-x-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-zinc-600 leading-relaxed">{{ $area['desc'] }}</p>
...
<section id="why-us" class="py-16 bg-primary text-white">
    <div class="container mx-auto px-4 lg:px-16">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="bg-white text-zinc-800 p-8 rounded-lg relative">
...
<section id="flow" class="py-16">
    <div class="container mx-auto px-4 lg:px-16">
        <div class="text-center mb-12">
            <p class="text-sm text-zinc-600 uppercase tracking-wider mb-2">How It Works</p>
            <h2 class="text-3xl md:text-4xl font-bold text-primary">ご相談の流れ</h2>
            <p class="mt-4 text-zinc-600">まずは状況を整理し、見通しと方針をご提案します。</p>
        </div>
...
<section id="pricing" class="py-16 bg-primary text-white">
    <div class="container mx-auto px-4 lg:px-16">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            ...
            <div class="bg-white text-zinc-800 p-8 rounded-lg">
        ...
        <div class="text-center">
            <a href="#" class="inline-block bg-white hover:bg-zinc-100 text-primary px-8 py-3 rounded-full font-bold transition">
                もっと詳しくみる
            </a>
        </div>
    </div>
...
<section id="testimonials" class="py-16 bg-primary-light">
    <div class="container mx-auto px-4 lg:px-16">
        <div class="text-center mb-12">
            <p class="text-sm text-zinc-600 uppercase tracking-wider mb-2">Customer Testimonials</p>
            ...
            <div class="bg-white p-6 rounded-lg border border-zinc-200">
                <div class="flex items-center mb-4">
                    <div class="w-12 h-12 bg-zinc-200 rounded-full flex items-center justify-center">
                        <i class="bi bi-person-fill text-2xl text-zinc-400"></i>
                    </div>
                    <div class="ml-4">
                        <p class="text-sm text-zinc-600">{{ $testimonial['name'] }}</p>
                    </div>
                </div>
                <p class="text-zinc-700 leading-relaxed">{{ $testimonial['comment'] }}</p>
            </div>
            @endforeach
        </div>
    </div>
...
<section id="faq" class="py-16 bg-secondary text-white">
    <div class="container mx-auto px-4 lg:px-16">
        ...
        <div class="max-w-3xl mx-auto space-y-4">
            ...
            @foreach($faqs as $faq)
            <details class="bg-white text-zinc-800 rounded-lg">
                <summary class="p-6 cursor-pointer font-bold flex items-center justify-between hover:bg-zinc-50 transition">
                    <span>{{ $faq['q'] }}</span>
...
<section class="py-16">
    <div class="container mx-auto px-4 lg:px-16">
        ...
        <div class="space-y-4">
            ...
            <div class="flex flex-col md:flex-row gap-4 pb-4 border-b border-zinc-200">
                <div class="text-sm text-zinc-600 md:w-32 flex-shrink-0">{{ $item['date'] }}</div>
