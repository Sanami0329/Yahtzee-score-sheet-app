<div>
    <div class="overflow-x-auto mt-14">
        <h1 class="my-8 text-2xl font-bold">Yahtzee（ヤッツィー）の遊び方</h1>

        <!-- ゲームの準備 -->
        <div class="py-4">
            <h2 class="mb-2 font-semibold text-xl">ゲームの準備</h2>
            <div class="mb-2">
                <h3 class="text-lg">プレイヤー人数</h3>
                <ul class="px-6 list-disc">
                    <li>1人～（通常2人～4人）</li>
                </ul>
            </div>
            <div class="mb-2">
                <h3 class="text-lg">準備するもの</h3>
                <ul class="px-6 list-disc">
                    <li>サイコロ５つ</li>
                    <li>【あれば便利】カップ（サイコロが四方に散らばるのを防ぎます）</li>
        ...
        <!-- ゲームの進め方 -->
        <div class="py-4">
            <h2 class="mb-2 font-semibold text-xl">ゲームの進め方</h2>
            <p class="mb-2">Yahtzeeは全13ラウンド。1ラウンドごとに全プレイヤーが必ず1回プレイします。</p>
            <ol class="px-6 !list-decimal">
                <li>
                    <div class="mb-2">
                        <h3 class="text-lg">サイコロを振る</h3>
                        <ul class="px-6 list-disc">
                ...
                <li>
                    <div class="mb-2">
                        <h3 class="text-lg">サイコロを振り直す（2回まで）</h3>
                        <ul class="px-6 list-disc">
                ...
                <li>
                    <div class="mb-2">
                        <h3 class="text-lg">スコア項目を選ぶ</h3>
                        <p>1ターンに必ず1つスコア項目を埋めます</p>
                        <ul class="px-6 list-disc">
                            <li>
                                振ったサイコロの目を見て、どのスコア項目に得点を入れるか決めます。
                                <p class="w-md my-2 py-2 px-4 border bg-zinc-50">
                                    例<br>
                                    2 2 5 5 5<br>
                            ...
                            <li>
                                得点を獲得できない場合も、どれか1つスコア項目を選び、0点を入れてそのターンを終了します。
                                <p class="w-md my-2 py-2 px-4 border bg-zinc-50">
                                    例<br>
        ...
        <!-- スコア項目・得点ルール -->
        <div class="py-4">
            <h2 class="mb-2 font-semibold text-xl">スコア項目・得点ルール</h2>
            <table class="my-4 border-collapse border border-zinc-600 text-zinc-800">
                {{-- Column Headers --}}
                <thead>
    ...
    <!-- 勝敗について -->
    <div class="py-4">
        <h2 class="mb-2 font-semibold text-xl">勝敗について</h2>
        <ul class="px-6 list-disc">
            <li>13ラウンド、全プレイヤーがすべてのスコア項目を埋めた時点で終了です。</li>
            <li>最も点数の高いプレイヤーが勝ちとなります。</li>
        </ul>
    </div>
</div>
</div>