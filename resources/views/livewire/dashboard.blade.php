<div class="pt-8">
    ...
    <div class="mx-auto my-8">
        <div class="flex flex-col items-center gap-6">
            ...
            <flux:card class="max-w-2xl h-12 flex justify-between items-center gap-20 p-6 bg-gray-50 rounded-lg shadow-md">
            ...
            <a href="{{ route('score.history') }}" class="block">
                <flux:card class="max-w-2xl h-12 flex justify-between items-center gap-20 p-6 bg-white hover:bg-brand-yellow-100 dark:hover:bg-brand-yellow-200 rounded-lg shadow-md">
